...
public class JpaMain {
    public static void main(String[] args) {
        ...
        try{
            ...
            grandChild1.setGrandChildId("grandChildId1");
            ...
            Parent findParent1 = entityManager.find(Parent.class, parent1.getParentId());
            System.out.println("findParent1 info is " + findParent1);

            ChildId childId = new ChildId();
            childId.setParent(parent1.getParentId());
            childId.setChildId(child1.getChildId());
            ...
            grandChildId.setGrandChildId(grandChild1.getGrandChildId());
